...
export default function Layout({ widthSize= 'col-md-12 col-sm-12', oneStep = 'First Step', twoStep, threeStep, fourStep, title = 'Empty Page', children }) {
    return (
        <>
            <div id="app" className='app app-header-fixed app-sidebar-fixed app-with-end-sidebar'>
                ...
                <div id="content" className="app-content">
                    ...
                    <div className={`panel panel-inverse float-end ` + widthSize}>
                        <ContainerMain>
                            {children}
                        </ContainerMain>
                    </div>
