...
<head>
  ...
  <link href="{{ asset('css/default/vendor.min.css') }}" rel="stylesheet" />
  <link href="{{ asset('css/default/app.min.css') }}" rel="stylesheet" />
  <link href="{{ asset('css/style.css') }}" rel="stylesheet" />
  <link href="{{ asset('css/default/table/dataTables.bootstrap4.min.css') }}" rel="stylesheet" />
  <link href="{{ asset('css/default/table/responsive.bootstrap4.min.css') }}" rel="stylesheet" />
...
<script src="{{ asset('assets/js/vendor.min.js') }}" type="13f396a5937c4d79640f697b-text/javascript"></script>
  ...
  <script src="{{ asset('assets/js/table/jquery.dataTables.min.js') }}" type="13f396a5937c4d79640f697b-text/javascript"></script>
  ...
  <script src="{{ asset('assets/js/rocket-loader.min.js') }}" data-cf-settings="13f396a5937c4d79640f697b-|49" defer=""></script>
  <!-- <script defer src="{{ asset('js/beacon.min.js') }}"
